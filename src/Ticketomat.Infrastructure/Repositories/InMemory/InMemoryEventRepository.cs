...
namespace Ticketomat.Infrastructure.Repositories.InMemory
{
    public class InMemoryEventRepository : IEventRepository
    {
        ...
        {
            new Event(Guid.NewGuid(), "Event 1", "Event 1 escription", DateTime.UtcNow.AddHours(2), DateTime.UtcNow.AddHours(4)),
            new Event(Guid.NewGuid(), "Event 2", "Event 2 escription", DateTime.UtcNow.AddHours(5), DateTime.UtcNow.AddHours(8))
        };
